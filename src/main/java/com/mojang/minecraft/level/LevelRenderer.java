...
public class LevelRenderer implements LevelListener {
    ...
    public void render(Player player, int layer) {
        GL11.glEnable(3553);
        GL11.glBindTexture(3553, this.textures.loadTexture("/assets/terrain.png", 9728));
    ...
    public void compileSurroundingGround() {
        GL11.glEnable(3553);
        GL11.glBindTexture(3553, this.textures.loadTexture("/assets/rock.png", 9728));
        ...
        for (int xx = 0; xx < this.level.width; xx += s) {
            t.vertexUV(xx + 0, 0.0F, 0.0F, 0.0F, 0.0F);
            t.vertexUV(xx + s, 0.0F, 0.0F, s, 0.0F);
            t.vertexUV(xx + s, y, 0.0F, s, y);
            t.vertexUV(xx + 0, y, 0.0F, 0.0F, y);
            t.vertexUV(xx + 0, y, this.level.height, 0.0F, y);
            t.vertexUV(xx + s, y, this.level.height, s, y);
            t.vertexUV(xx + s, 0.0F, this.level.height, s, 0.0F);
            t.vertexUV(xx + 0, 0.0F, this.level.height, 0.0F, 0.0F);
        }

        GL11.glColor3f(0.6F, 0.6F, 0.6F);

        for (int zz = 0; zz < this.level.height; zz += s) {
            t.vertexUV(0.0F, y, zz + 0, 0.0F, 0.0F);
            t.vertexUV(0.0F, y, zz + s, s, 0.0F);
            t.vertexUV(0.0F, 0.0F, zz + s, s, y);
            t.vertexUV(0.0F, 0.0F, zz + 0, 0.0F, y);
            t.vertexUV(this.level.width, 0.0F, zz + 0, 0.0F, y);
            t.vertexUV(this.level.width, 0.0F, zz + s, s, y);
            t.vertexUV(this.level.width, y, zz + s, s, 0.0F);
            t.vertexUV(this.level.width, y, zz + 0, 0.0F, 0.0F);
        }
    ...
    public void compileSurroundingWater() {
        ...
        GL11.glBindTexture(3553, this.textures.loadTexture("/assets/water.png", 9728));
    ...
    public void pick(Player player, Frustum frustum) {
        ...
        for (int x = x0; x < x1; x++) {
            ...
            for (int y = y0; y < y1; y++) {
                ...
                for (int z = z0; z < z1; z++) {
                    Tile tile = Tile.terrainTiles[this.level.getTile(x, y, z)];
    ...
    public void renderBlockHighlight (Player player, HitResult h, boolean creative, int tileType) {
        Tesselator t = Tesselator.instance;
        ...
        if (!creative) {
            ...
            float br = (float)Math.sin(System.currentTimeMillis() / 100.0) * 0.2F + 0.8F;
            ...
            t.begin();
            t.noColor();
            Tile.terrainTiles[tileType].render(t, this.level, 0, x, y, z);
            Tile.terrainTiles[tileType].render(t, this.level, 1, x, y, z);
            t.end();
    ...
    public void renderBlockOutline (Player player, HitResult h, boolean selectOrWireframe, int tileType) {
        GL11.glEnable(GL11.GL_BLEND);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
